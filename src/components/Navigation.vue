    ...
    <div class="container-fluid">
      ...
      <div id="nav" class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <router-link to="/dashboard" class="nav-link" active-class="active" v-if="isLoggedIn">Dashboard</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/transfer" class="nav-link" active-class="active" v-if="isLoggedIn">Transfer</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/account" class="nav-link" active-class="active" v-if="isLoggedIn">Account</router-link>
          </li>
          <li class="nav-item">
